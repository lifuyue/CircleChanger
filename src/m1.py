...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.times_of_change_to_next_color_in_tuple = 0
    ...
    def swallow(self, other_circle_changer):
        ...
        return CircleChanger(center.x, center.y, radius, 'red', self.colors + other_circle_changer.colors)
    ...
    def change_to_next_color_in_tuple(self):
        ...
        ################################################################
        self.circle.fill_color = self.colors[self.times_of_change_to_next_color_in_tuple]
        self.times_of_change_to_next_color_in_tuple += 1
        if self.times_of_change_to_next_color_in_tuple > len(self.colors) - 1:
            self.times_of_change_to_next_color_in_tuple = 0
